...
type PercosisCustomClient struct {
...
// configFilePath.
func writeConfigToFile(configFilePath string, config *PercosisCustomClient) error {
...
func getClientConfig(configPath string, v *viper.Viper) (*PercosisCustomClient, error) {
...
func SetCustomEnvVariablesFromClientToml(ctx client.Context) {
	...
	// gas
	setEnvFromConfig("gas", "PERCOSISD_GAS")
	setEnvFromConfig("gas-prices", "PERCOSISD_GAS_PRICES")
	setEnvFromConfig("gas-adjustment", "PERCOSISD_GAS_ADJUSTMENT")
	// fees
	setEnvFromConfig("fees", "PERCOSISD_FEES")
}
