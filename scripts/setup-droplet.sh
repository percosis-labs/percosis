...
export REPO=https://github.com/percosis-labs/percosis.git
export BRANCH=main
export NODE=percosisd
export CLI=percosisd
...
export CHAINID="perco-testnet-thanatos"
...
cp ./build/percosisd /root/go/bin/
