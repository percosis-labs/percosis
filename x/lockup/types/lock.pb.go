...
// source: percosis/lockup/lock.proto
...
func (LockQueryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d5ec49d5986bbd12, []int{0}
}
...
type QueryCondition struct {
	...
	LockQueryType LockQueryType `protobuf:"varint,1,opt,name=lock_query_type,json=lockQueryType,proto3,enum=percosis.lockup.LockQueryType" json:"lock_query_type,omitempty"`
...
func (*QueryCondition) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5ec49d5986bbd12, []int{1}
}
...
func (*SyntheticLock) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5ec49d5986bbd12, []int{2}
}
...
func init() {
	proto.RegisterEnum("percosis.lockup.LockQueryType", LockQueryType_name, LockQueryType_value)
	proto.RegisterType((*PeriodLock)(nil), "percosis.lockup.PeriodLock")
	proto.RegisterType((*QueryCondition)(nil), "percosis.lockup.QueryCondition")
	proto.RegisterType((*SyntheticLock)(nil), "percosis.lockup.SyntheticLock")
}

func init() { proto.RegisterFile("percosis/lockup/lock.proto", fileDescriptor_d5ec49d5986bbd12) }

var fileDescriptor_d5ec49d5986bbd12 = []byte{
	// 647 bytes of a gzipped FileDescriptorProto
	,
}
