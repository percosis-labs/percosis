...
import (
	...
	types "github.com/percosis-labs/percosis/v16/x/downtime-detector/types"
...
func init() {
	proto.RegisterFile("percosis/downtime-detector/v1beta1/query.proto", fileDescriptor_b748b3d07fa8b8cb)
}
