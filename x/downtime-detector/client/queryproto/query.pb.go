...
// source: percosis/downtime-detector/v1beta1/query.proto
...
import (
	...
	types "github.com/percosis-labs/percosis/x/downtime-detector/types"
...
type RecoveredSinceDowntimeOfLengthRequest struct {
	Downtime types.Downtime `protobuf:"varint,1,opt,name=downtime,proto3,enum=percosis.downtimedetector.v1beta1.Downtime" json:"downtime,omitempty" yaml:"downtime"`
...
func (*RecoveredSinceDowntimeOfLengthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f17452830ba6583f, []int{0}
}
...
func (*RecoveredSinceDowntimeOfLengthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f17452830ba6583f, []int{1}
}
...
func init() {
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthRequest)(nil), "percosis.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthResponse)(nil), "percosis.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
}

func init() {
	proto.RegisterFile("percosis/downtime-detector/v1beta1/query.proto", fileDescriptor_f17452830ba6583f)
}

var fileDescriptor_f17452830ba6583f = []byte{
	// 485 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) RecoveredSinceDowntimeOfLength(ctx context.Context, in *RecoveredSinceDowntimeOfLengthRequest, opts ...grpc.CallOption) (*RecoveredSinceDowntimeOfLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/percosis.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveredSinceDowntimeOfLength_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/percosis.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "percosis.downtimedetector.v1beta1.Query",
	...
	Metadata: "percosis/downtime-detector/v1beta1/query.proto",
}
