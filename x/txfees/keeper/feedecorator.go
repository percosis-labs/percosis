...
import (
	...
	"github.com/percosis-labs/percosis/v16/x/txfees/keeper/txfee_filters"
...
// IsSufficientFee checks if the feeCoin provided (in any asset), is worth enough perco at current spot prices
