...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdatePoolIncentivesProposal{}, "percosis/UpdatePoolIncentivesProposal")
	govtypes.RegisterProposalType(ProposalTypeReplacePoolIncentives)
	govtypes.RegisterProposalTypeCodec(&ReplacePoolIncentivesProposal{}, "percosis/ReplacePoolIncentivesProposal")
}
