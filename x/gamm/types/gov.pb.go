...
import (
	...
	migration "github.com/percosis-labs/percosis/v16/x/gamm/types/migration"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
func init() { proto.RegisterFile("percosis/gamm/v1beta1/gov.proto", fileDescriptor_f31b9a6c0dbbdfa3) }
