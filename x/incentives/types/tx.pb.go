...
// source: percosis/incentives/tx.proto
...
import (
	...
	types "github.com/percosis-labs/percosis/x/lockup/types"
...
func (*MsgCreateGauge) Descriptor() ([]byte, []int) {
	return fileDescriptor_26dce9077846a1fd, []int{0}
}
...
func (*MsgCreateGaugeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_26dce9077846a1fd, []int{1}
}
...
func (*MsgAddToGauge) Descriptor() ([]byte, []int) {
	return fileDescriptor_26dce9077846a1fd, []int{2}
}
...
func (*MsgAddToGaugeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_26dce9077846a1fd, []int{3}
}
...
func init() {
	proto.RegisterType((*MsgCreateGauge)(nil), "percosis.incentives.MsgCreateGauge")
	proto.RegisterType((*MsgCreateGaugeResponse)(nil), "percosis.incentives.MsgCreateGaugeResponse")
	proto.RegisterType((*MsgAddToGauge)(nil), "percosis.incentives.MsgAddToGauge")
	proto.RegisterType((*MsgAddToGaugeResponse)(nil), "percosis.incentives.MsgAddToGaugeResponse")
}

func init() { proto.RegisterFile("percosis/incentives/tx.proto", fileDescriptor_26dce9077846a1fd) }

var fileDescriptor_26dce9077846a1fd = []byte{
	// 645 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) CreateGauge(ctx context.Context, in *MsgCreateGauge, opts ...grpc.CallOption) (*MsgCreateGaugeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/percosis.incentives.Msg/CreateGauge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddToGauge(ctx context.Context, in *MsgAddToGauge, opts ...grpc.CallOption) (*MsgAddToGaugeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/percosis.incentives.Msg/AddToGauge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGauge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/percosis.incentives.Msg/CreateGauge",
	}
...
func _Msg_AddToGauge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/percosis.incentives.Msg/AddToGauge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "percosis.incentives.Msg",
	...
	Metadata: "percosis/incentives/tx.proto",
}
