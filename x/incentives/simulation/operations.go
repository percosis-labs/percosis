...
func WeightedOperations(
	...
	bk percosimtypes.BankKeeper, ek types.EpochKeeper, k keeper.Keeper,
...
func SimulateMsgCreateGauge(ak stakingTypes.AccountKeeper, bk percosimtypes.BankKeeper, ek types.EpochKeeper, k keeper.Keeper) simtypes.Operation {
	return func(
...
func SimulateMsgAddToGauge(ak stakingTypes.AccountKeeper, bk percosimtypes.BankKeeper, k keeper.Keeper) simtypes.Operation {
	return func(
		r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
	) (simtypes.OperationMsg, []simtypes.FutureOperation, error) {
		simAccount, _ := simtypes.RandomAcc(r, accs)
