...
Percosis implements the following custom modules:
...
* `superfluid` - Defines superfluid staking, allowing DeFi assets to have their perco-backing be staked.
...
* `txfees` - Contains logic for whitelisting txfee tokens, making them easily priceable in perco, and auto-swapping to perco.
  * Also contains logic for custom Percosis mempool logic, though this should perhaps relocate.
