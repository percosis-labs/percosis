...
import (
	...
	github_com_percosis_labs_percosis_osmomath "github.com/percosis-labs/percosis/osmomath"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type Pool struct {
	...
	CurrentSqrtPrice     github_com_percosis_labs_percosis_osmomath.BigDec `protobuf:"bytes,8,opt,name=current_sqrt_price,json=currentSqrtPrice,proto3,customtype=github.com/percosis-labs/percosis/osmomath.BigDec" json:"current_sqrt_price" yaml:"spot_price"`
...
func init() {
	proto.RegisterFile("percosis/concentrated-liquidity/pool.proto", fileDescriptor_3526ea5373d96c9a)
}
