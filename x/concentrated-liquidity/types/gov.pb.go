...
// source: percosis/concentrated-liquidity/gov.proto
...
func (*CreateConcentratedLiquidityPoolsProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_6752a2b340080782, []int{0}
}
...
func (*TickSpacingDecreaseProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_6752a2b340080782, []int{1}
}
...
func (*PoolIdToTickSpacingRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_6752a2b340080782, []int{2}
}
...
func (*PoolRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_6752a2b340080782, []int{3}
}
...
func init() {
	proto.RegisterType((*CreateConcentratedLiquidityPoolsProposal)(nil), "percosis.concentratedliquidity.v1beta1.CreateConcentratedLiquidityPoolsProposal")
	proto.RegisterType((*TickSpacingDecreaseProposal)(nil), "percosis.concentratedliquidity.v1beta1.TickSpacingDecreaseProposal")
	proto.RegisterType((*PoolIdToTickSpacingRecord)(nil), "percosis.concentratedliquidity.v1beta1.PoolIdToTickSpacingRecord")
	proto.RegisterType((*PoolRecord)(nil), "percosis.concentratedliquidity.v1beta1.PoolRecord")
}

func init() {
	proto.RegisterFile("percosis/concentrated-liquidity/gov.proto", fileDescriptor_6752a2b340080782)
}

var fileDescriptor_6752a2b340080782 = []byte{
	// 579 bytes of a gzipped FileDescriptorProto
	,
}
