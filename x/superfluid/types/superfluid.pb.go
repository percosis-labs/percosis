...
// source: percosis/superfluid/superfluid.proto
...
func (SuperfluidAssetType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{0}
}
...
type SuperfluidAsset struct {
	...
	// share
	AssetType SuperfluidAssetType `protobuf:"varint,2,opt,name=asset_type,json=assetType,proto3,enum=percosis.superfluid.SuperfluidAssetType" json:"asset_type,omitempty"`
}
...
// and PERCO tokens for superfluid staking. The intermediary account is the
...
func (*SuperfluidIntermediaryAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{1}
}
...
// The Perco-Equivalent-Multiplier Record for epoch N refers to the perco worth
// we treat an LP share as having, for all of epoch N. Eventually this is
// intended to be set as the Time-weighted-average-perco-backing for the entire
// duration of epoch N-1. (Thereby locking whats in use for epoch N as based on
// the prior epochs rewards) However for now, this is not the TWAP but instead
// the spot price at the boundary. For different types of assets in the future,
// it could change.
type PercoEquivalentMultiplierRecord struct {
...
func (m *PercoEquivalentMultiplierRecord) Reset()         { *m = PercoEquivalentMultiplierRecord{} }
func (m *PercoEquivalentMultiplierRecord) String() string { return proto.CompactTextString(m) }
func (*PercoEquivalentMultiplierRecord) ProtoMessage()    {}
func (*PercoEquivalentMultiplierRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{2}
}
func (m *PercoEquivalentMultiplierRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PercoEquivalentMultiplierRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PercoEquivalentMultiplierRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PercoEquivalentMultiplierRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PercoEquivalentMultiplierRecord.Merge(m, src)
}
func (m *PercoEquivalentMultiplierRecord) XXX_Size() int {
	return m.Size()
}
func (m *PercoEquivalentMultiplierRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_PercoEquivalentMultiplierRecord.DiscardUnknown(m)
}

var xxx_messageInfo_PercoEquivalentMultiplierRecord proto.InternalMessageInfo

func (m *PercoEquivalentMultiplierRecord) GetEpochNumber() int64 {
	if m != nil {
...
func (m *PercoEquivalentMultiplierRecord) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (*SuperfluidDelegationRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{3}
}
...
func (*LockIdIntermediaryAccountConnection) Descriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{4}
}
...
func (*UnpoolWhitelistedPools) Descriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{5}
}
...
func (*ConcentratedPoolUserPositionRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_c15bc64dbb8514df, []int{6}
}
...
func init() {
	proto.RegisterEnum("percosis.superfluid.SuperfluidAssetType", SuperfluidAssetType_name, SuperfluidAssetType_value)
	proto.RegisterType((*SuperfluidAsset)(nil), "percosis.superfluid.SuperfluidAsset")
	proto.RegisterType((*SuperfluidIntermediaryAccount)(nil), "percosis.superfluid.SuperfluidIntermediaryAccount")
	proto.RegisterType((*PercoEquivalentMultiplierRecord)(nil), "percosis.superfluid.PercoEquivalentMultiplierRecord")
	proto.RegisterType((*SuperfluidDelegationRecord)(nil), "percosis.superfluid.SuperfluidDelegationRecord")
	proto.RegisterType((*LockIdIntermediaryAccountConnection)(nil), "percosis.superfluid.LockIdIntermediaryAccountConnection")
	proto.RegisterType((*UnpoolWhitelistedPools)(nil), "percosis.superfluid.UnpoolWhitelistedPools")
	proto.RegisterType((*ConcentratedPoolUserPositionRecord)(nil), "percosis.superfluid.ConcentratedPoolUserPositionRecord")
}

func init() {
	proto.RegisterFile("percosis/superfluid/superfluid.proto", fileDescriptor_c15bc64dbb8514df)
}

var fileDescriptor_c15bc64dbb8514df = []byte{
	// 816 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *PercoEquivalentMultiplierRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PercoEquivalentMultiplierRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PercoEquivalentMultiplierRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PercoEquivalentMultiplierRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PercoEquivalentMultiplierRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PercoEquivalentMultiplierRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PercoEquivalentMultiplierRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
