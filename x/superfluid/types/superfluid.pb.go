...
// The Perco-Equivalent-Multiplier Record for epoch N refers to the perco worth we
// treat an LP share as having, for all of epoch N. Eventually this is intended
// to be set as the Time-weighted-average-perco-backing for the entire duration
...
func init() {
	proto.RegisterFile("percosis/superfluid/superfluid.proto", fileDescriptor_79d3c29d82dbb734)
}
