...
func (k Keeper) InitGenesis(ctx sdk.Context, genState types.GenesisState) {
	...
	for _, multiplierRecord := range genState.PercoEquivalentMultipliers {
		k.SetPercoEquivalentMultiplier(ctx, multiplierRecord.EpochNumber, multiplierRecord.Denom, multiplierRecord.Multiplier)
	}
...
func (k Keeper) ExportGenesis(ctx sdk.Context) *types.GenesisState {
	return &types.GenesisState{
		...
		PercoEquivalentMultipliers:     k.GetAllPercoEquivalentMultipliers(ctx),
