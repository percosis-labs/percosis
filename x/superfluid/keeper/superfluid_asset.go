...
// See https://github.com/percosis-labs/percosis/issues/864
func (k Keeper) BeginUnwindSuperfluidAsset(ctx sdk.Context, epochNum int64, asset types.SuperfluidAsset) {
	...
	k.SetPercoEquivalentMultiplier(ctx, epochNum, asset.Denom, sdk.ZeroDec())
...
func (k Keeper) GetRiskAdjustedPercoValue(ctx sdk.Context, amount sdk.Int) sdk.Int {
...
func (k Keeper) UnriskAdjustPercoValue(ctx sdk.Context, amount sdk.Dec) sdk.Dec {
	minRiskFactor := k.GetParams(ctx).MinimumRiskFactor
...
func (k Keeper) AddNewSuperfluidAsset(ctx sdk.Context, asset types.SuperfluidAsset) error {
	// initialize perco equivalent multipliers
	...
	return osmoutils.ApplyFuncIfNoError(ctx, func(ctx sdk.Context) error {
		...
		err := k.UpdatePercoEquivalentMultipliers(ctx, asset, currentEpoch)
		return err
	})
}
