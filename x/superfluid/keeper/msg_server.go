...
import (
	...
	"github.com/percosis-labs/percosis/v16/x/superfluid/keeper/internal/events"
...
// Note that the amount of delegation is not equal to the equivalent amount of perco within the lock.
// Instead, we use the perco equivalent multiplier stored in the latest epoch, calculate how much
// perco equivalent is in lock, and use the risk adjusted perco value. The minimum risk ratio works as a parameter
