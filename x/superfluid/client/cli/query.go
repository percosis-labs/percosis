...
func GetCmdAllSuperfluidAssets() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.AllAssetsRequest](
...
func GetCmdAssetMultiplier() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.AssetMultiplierRequest](
...
func GetCmdAllIntermediaryAccounts() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.AllIntermediaryAccountsRequest](
...
func GetCmdConnectedIntermediaryAccount() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.ConnectedIntermediaryAccountRequest](
...
func GetCmdSuperfluidDelegationAmount() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.SuperfluidDelegationAmountRequest](
...
func GetCmdSuperfluidUndelegationsByDelegator() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.SuperfluidUndelegationsByDelegatorRequest](
...
func GetCmdTotalSuperfluidDelegations() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.TotalSuperfluidDelegationsRequest](
		"total-superfluid-delegations",
		"Query total amount of perco delegated via superfluid staking", "",
		types.ModuleName, types.NewQueryClient,
	)
}

func GetCmdTotalDelegationByDelegator() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.QueryTotalDelegationByDelegatorRequest](
...
func GetCmdUnpoolWhitelist() *cobra.Command {
	return percocli.SimpleQueryCmd[*types.QueryUnpoolWhitelistRequest](
		"unpool-whitelist",
