...
// source: percosis/tokenfactory/v1beta1/authorityMetadata.proto
...
type DenomAuthorityMetadata struct {
	// Can be empty for no admin, or a valid percosis address
...
func (*DenomAuthorityMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_ba9734a7aacdf7d5, []int{0}
}
...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "percosis.tokenfactory.v1beta1.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("percosis/tokenfactory/v1beta1/authorityMetadata.proto", fileDescriptor_ba9734a7aacdf7d5)
}

var fileDescriptor_ba9734a7aacdf7d5 = []byte{
	// 239 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x32, 0x2d, 0x48, 0x2d, 0x4a,
	...
	0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xc3, 0x7c, 0xa0, 0x9b, 0x93, 0x98, 0x54,
	0x0c, 0xe7, 0xe9, 0x57, 0xa0, 0x06, 0x44, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8, 0x81,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xc6, 0x73, 0x22, 0x13, 0x2e, 0x01, 0x00, 0x00,
}
