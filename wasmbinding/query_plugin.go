...
func CustomQuerier(qp *QueryPlugin) func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
	return func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
		var contractQuery bindings.PercosisQuery
		if err := json.Unmarshal(request, &contractQuery); err != nil {
			return nil, errorsmod.Wrap(err, "percosis query")
		}
		...
		case contractQuery.FullDenom != nil:
			...
			if err != nil {
				return nil, errorsmod.Wrap(err, "perco full denom query")
			}
			...
			if err != nil {
				return nil, errorsmod.Wrap(err, "perco full denom query response")
			}
		...
		default:
			return nil, wasmvmtypes.UnsupportedRequest{Kind: "unknown percosis query variant"}
		}
	}
}
