...
// RunForkLogic executes height-gated on-chain fork logic for the Percosis v3
// upgrade.
func RunForkLogic(ctx sdk.Context, keepers *keepers.AppKeepers) {
	ctx.Logger().Info("Applying Percosis v3 upgrade." +
...
// Fixes an error where minimum deposit was set to "500 perco". This denom does
