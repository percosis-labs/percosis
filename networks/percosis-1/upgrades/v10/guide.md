...
You will need to be running go1.18 for this version of Percosis. You can check if you are running go1.18 with the following command:
...
make build
cp build/percosisd ~/.percosisd/cpercovisor/upgrades/v9/bin
```
...
If you need more help, please go to <https://docs.percosis.zone> or join our discord at <https://discord.gg/pAxjcFnAFH>.
